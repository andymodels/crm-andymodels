...
/** Telefone BR para exibição: (XX) XXXXX-XXXX ou (XX) XXXX-XXXX */
...
/** Telefone BR: exatamente 10 ou 11 dígitos (DDD + 8 ou 9 dígitos) */
...
function sanitizeAndValidateModelo(body, partial = false) {
  ...
  /** formas_pagamento: validado em App (sanitizeAndValidateFormasPagamentoArray) e no backend */
